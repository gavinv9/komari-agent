...
komari_args="$komari_args --update-repo $install_repo"
...
if [ -n "$github_proxy" ]; then
    ...
    download_url="${github_proxy}/https://github.com/${install_repo}/releases/${download_path}/${file_name}"
else
    # Direct access to GitHub releases
    download_url="https://github.com/${install_repo}/releases/${download_path}/${file_name}"
fi
